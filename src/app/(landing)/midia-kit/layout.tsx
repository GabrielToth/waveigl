...
export const metadata: Metadata = {
  ...
  description: 'Mídia Kit oficial do WaveIGL. Alcance uma audiência de 2M+ views mensais, 513k+ seguidores. Dados demográficos, formatos de anúncio e contato comercial.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Alcance 2M+ views mensais e 513k+ seguidores. Mídia Kit oficial com dados demográficos e formatos de anúncio.',
  ...
  twitter: {
    ...
    title: 'Mídia Kit WaveIGL - Anuncie para Gamers',
    description: 'Alcance 2M+ views mensais e 513k+ seguidores. Contato: csgoblackbelt@gmail.com',
